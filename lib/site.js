...
/**
 * Kanały społecznościowe klubu — jedno źródło prawdy dla hero i stopki.
 * Uchwyty do potwierdzenia przez klienta (placeholdery na czas budowy).
 */
export const SOCIALS = [
  { key: 'instagram', label: 'Instagram', href: 'https://instagram.com/zakleterewiry' },
  { key: 'facebook', label: 'Facebook', href: 'https://facebook.com/zakleterewiry' },
  { key: 'tiktok', label: 'TikTok', href: 'https://tiktok.com/@zakleterewiry' },
  { key: 'youtube', label: 'YouTube', href: 'https://youtube.com/@zakleterewiry' },
  { key: 'mail', label: 'E-mail', href: 'mailto:bilety@zakletyrewiry.pl' },
];
