...
export const GENRES = [
  ...
  'Stand-up', 'Teatr', 'Sport', 'Impreza', 'Inne',
];
...
export function getStatusLabel(event) {
  switch (event.status) {
    case 'dostepne':     return 'DOSTĘPNE';
    case 'ostatnie':     return `OSTATNIE ${event.pool - event.sold}`;
    case 'wyprzedane':   return 'WYPRZEDANE';
    case 'przedsprzedaz': return 'PRZEDSPRZEDAŻ';
    default: return '';
  }
}
