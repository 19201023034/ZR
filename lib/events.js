...
export const ROOMS = {
  'Sala Duża': {
    /* Galeria prowadzi realizacjami, nie pustą salą: klient B2B najpierw musi
       zobaczyć swoje wydarzenie w tej przestrzeni, a dopiero potem sam kadr. */
    photos: [
      '/assets/eventy/event-07.jpg',             // gala — okrągłe stoły i scena
      '/assets/teatr/teatr-uklad-teatralny.jpg', // układ teatralny / konferencja
      '/assets/koncerty/koncert-02.jpg',         // koncert na komplet
      '/assets/teatr/teatr-orkiestra.jpg',       // orkiestra symfoniczna
      '/assets/eventy/event-17.jpg',             // show sceniczny
      '/assets/eventy/event-22.jpg',             // goście, foyer przy muralu
      '/assets/venue/s1.webp',                   // pusta scena
      '/assets/venue/s3.webp',
      '/assets/venue/s2.webp',
    ],
    area: 550,
